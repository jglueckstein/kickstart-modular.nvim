...
-- Neotree keymaps
vim.keymap.set('n', '<Leader>tf', '<CMD>Neotree toggle current reveal_force_cwd<CR>', { desc = 'neo[T]ree toggle [F]ile tree' })
...
vim.keymap.set('n', '<Leader>tb', '<CMD>Neotree toggle show buffers right<CR>', { desc = 'neo[T]ree toggle [B]uffers in tree' })
